...
public class EmpleadoDAO {
    ...
    public Empleado obtenerEmpleadoPorIdUsuario(int idUsuario) {
        ...
        String query = "SELECT id_empleado, nombre, cargo, es_jefe_cuadrilla, id_cuadrilla, id_usuario FROM empleados WHERE id_usuario = ?";
        ...
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            System.out.println("Error al obtener empleado por ID de usuario: " + e.getMessage());
        }
        return empleado;
    }
